...
public static void main(String[] args)
{
	...
	if(iMonth == 3 && (aDay <= 31 && aDay >= 21))
		
		System.out.println("You are an Aries!");
		
	if(iMonth == 4 && (aDay <= 0 && aDay >= 19));
	
		System.out.println("You are an Aries!");//These two were for telling the computer what an Aries is.
		
	if(iMonth == 4 && (aDay <= 20 && aDay >= 30));
	
		System.out.println("You are a Taurus!");
		
	if(iMonth == 5 && (aDay <= 0 && aDay >=20));
